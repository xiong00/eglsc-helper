...
public class ArrayUtil  {
    ...
    public static Object[] wrap(Object obj) {
        if(isArray(obj)) {
            ...
            throw new UtilException(StringHelper.format("[{}] is not Array!", new Object[]{obj.getClass()}));
        }
    }
    ...
    public static String join(Object array, String conjunction) {
        if(isArray(array)) {
            ...
            throw new UtilException(StringHelper.format("[{}] is not a Array!", new Object[]{array.getClass()}));
        }
    }
