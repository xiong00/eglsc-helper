...
import com.eglsc.lang.ClassScaner;
import com.eglsc.lang.Filter;
...
public class ClassUtils {
    ...
    public static Set<String> getClassPaths(String packageName) {
        ...
        try {
            ...
            throw new UtilException(StringHelper.format("Loading classPath [{}] error!", new Object[]{packagePath}), var4);
        }
    ...
    public static <T> T newInstance(Class<T> clazz) {
        try {
            ...
            throw new UtilException(StringHelper.format("Instance class [{}] error!", new Object[]{clazz}), var2);
        }
    }
        ...
        if(ArrayUtil.isEmpty(params)) {
            ...
            if(null == constructor) {
                ...
                try {
                    ...
                    throw new UtilException(StringHelper.format("Instance class [{}] error!", new Object[]{clazz}), var5);
                }
            }
        }
    }
