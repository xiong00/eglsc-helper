...
public class CharsetUtil {
    ...
    public static Charset charset(String charsetName) {
        return StringHelper.isBlank(charsetName)?Charset.defaultCharset():Charset.forName(charsetName);
    }
    ...
    public static String convert(String source, Charset srcCharset, Charset destCharset) {
        ...
        return !StringHelper.isBlank(source) && !srcCharset.equals(destCharset)?new String(source.getBytes(srcCharset), destCharset):source;
    }
