...
public class URLUtil {
    ...
    public static URL getURL(String pathBaseClassLoader) {
        return ClassUtils.getClassLoader().getResource(pathBaseClassLoader);
    }
    ...
    public static String formatUrl(String url) {
        return StringHelper.isBlank(url)?null:(!url.startsWith("http://") && !url.startsWith("https://")?"http://" + url:url);
    }
