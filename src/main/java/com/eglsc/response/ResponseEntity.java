...
public class ResponseEntity {
    ...
    public static String convertResult(Object rows ,int currentPage,int pageSize ,long totalPage)
    {
        ...
        jsonResult.append("}");
        jsonResult.append(",");
        jsonResult.append("\"rows\"" + ":" + JSON.toJSONString(rows, config,features));
        jsonResult.append("}");
    ...
    public static String SuccessResult(Object rows ,long total) {
        ...
        jsonResult.append("\"status\""+":"+"200");
        jsonResult.append(",");
        jsonResult.append("\"msg\"" + ":" +JSON.toJSONString(SUCCESS_MESSAGE));
        jsonResult.append(",");
        jsonResult.append("\"total\"" + ":" + total);
        jsonResult.append(",");
        jsonResult.append("\"rows\"" + ":" + JSON.toJSONString(rows, config, features));
    ...
    public static String SuccessResult(Object result,String msg) {
        ...
        jsonResult.append("\"status\""+":"+"200");
        jsonResult.append(",");
        jsonResult.append("\"msg\"" + ":" + JSON.toJSONString(msg));
        jsonResult.append(",");
        jsonResult.append("\"rows\"" + ":" + JSON.toJSONString(result, config, features));
        jsonResult.append("}");
